...
const ApprovalPage = ({ registrations }) => {
  ...
  return (
    <div className="space-y-6 animation-fade-in relative">
      ...
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-slate-800">Approval / Onboarding</h1>
        <p className="text-slate-500 text-sm">Verifikasi dokumen merchant baru (Role: Maker/Checker).</p>
      </div>
